...
def main():
    ...
    # Ajuste o caminho caso o nome do CSV seja diferente:
    ...
    #    Lógica aproximada: se um cliente fez só 1 compra,
    #    consideramos que abandonou (1) — senão (0).
